            ...
            if (((comboBoxTypeOperation.Text == "Перемещение материалов" || comboBoxTypeOperation.Text == "Отпуск материалов") && differenceMaterialCount > Convert.ToInt32(textBoxCount.Text.ToString())) || comboBoxTypeOperation.Text == "Поступление материалов")
            {
                if (upd)
                {
                    if (comboBoxTypeOperation.Text == "Поступление материалов")
                    {
                        ...
                        addProvodki = "update Journal_Provodok set DateOperation='" + dateOperation + "', ShetDT=" + 10 + ",Subkonto1Dt='" + comboBoxMaterial.Text.ToString() + "', Subkonto2Dt='" + comboBoxStock1.Text.ToString() + "', Subkonto3Dt='" + comboBoxMOL.Text.ToString() + "', ShetKT=" + 60 + ", Subkonto1Kt='" + comboBoxProvider.Text.ToString() + "', Sum ='" + textBoxSumOperation.Text.ToString() + "', Count='" + textBoxCount.Text.ToString() + "' where JournalOperationKod=" + id;
                    }
                    if (comboBoxTypeOperation.Text == "Перемещение материалов")
                    {
                        ...
                        addProvodki = "update Journal_Provodok set DateOperation='" + dateOperation + "', ShetDT=" + 10 + ",Subkonto1Dt='" + comboBoxMaterial.Text.ToString() + "', Subkonto2Dt='" + comboBoxStock2.Text.ToString() + "', Subkonto3Dt='" + comboBoxMOL2.Text.ToString() + "', ShetKT=" + 10 + ",Subkonto1Kt='" + comboBoxMaterial.Text.ToString() + "', Subkonto2Kt='" + comboBoxStock1.Text.ToString() + "', Subkonto3Dt='" + comboBoxMOL.Text.ToString() + "', Sum ='" + textBoxSumOperation.Text.ToString() + "', Count='" + textBoxCount.Text.ToString() + "' where JournalOperationKod=" + id;
                    }
                    if (comboBoxTypeOperation.Text == "Отпуск материалов")
                    {
                        ...
                        addProvodki = "update Journal_Provodok set DateOperation='" + dateOperation + "', ShetDT=" + 20 + ",Subkonto1Dt='" + comboBoxPodrazdel.Text.ToString() + "', ShetKT=" + 10 + ", Subkonto1Kt='" + comboBoxMaterial.Text.ToString() + "', Subkonto2Kt='" + comboBoxStock1.Text.ToString() + "', Subkonto3Kt='" + comboBoxMOL2.Text.ToString() + "', Sum ='" + textBoxSumOperation.Text.ToString() + "', Count='" + textBoxCount.Text.ToString() + "' where JournalOperationKod=" + id;
                    }
                    changeValue(ConnectionString, add);
                    changeValue(ConnectionString, addProvodki);
                }
                else
                {
                    if (comboBoxTypeOperation.Text == "Поступление материалов")

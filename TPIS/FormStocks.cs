...
namespace TPIS
{
    public partial class FormStocks : Form
    {
        ...
        private void FormStock_Load(object sender, EventArgs e)
        {
            ...
            String selectCommand = "Select * from Store";
            selectTable(ConnectionString, selectCommand);
        }
        ...
        private void toolStripButtonAdd_Click(object sender, EventArgs e)
        {
            ...
            string ConnectionString = @"Data Source=" + sPath + ";New=False;Version=3";
            String selectCommand = "select MAX(idStore) from Store";
            ...
            {
                //вставка в таблицу
                string txtSQLQuery = "insert into Store (idStore, Name) values (" + (Convert.ToInt32(maxValue) + 1) + ", '" + toolStripTextBox.Text + "')";
        ...
        private void toolStripButton1_Click(object sender, EventArgs e)
        {
            ...
            {
                //обновление Name 
                String selectCommand = "update Store set Name='" + changeName + "' where idStore=" + valueId;
                string ConnectionString = @"Data Source=" + sPath + ";New=False;Version=3";
        ...
        private void toolStripButtonDell_Click(object sender, EventArgs e)
        {
            ...
            string valueId = dataGridView1[0, CurrentRow].Value.ToString();
            String selectCommand = "delete from Store where idStore=" + valueId;
            string ConnectionString = @"Data Source=" + sPath + ";New=False;Version=3";
            changeValue(ConnectionString, selectCommand);
            //обновление dataGridView1
            selectCommand = "select * from Store";
